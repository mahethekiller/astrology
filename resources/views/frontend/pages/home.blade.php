...
<div class="section4 ">
  <div class="container ">
    <h2 class="title2 ">Top Astrologers</h2>
    <div class="headingDeign"><img src="images/headingDesign.png" /></div>
    <div class="row pt40">
    ...
    <div class="viewAllBlog">
      <a class="customBtn" href="{{ route('astrologer.index') }}">VIEW ALL ASTROLOGERS <img src="images/readmorearrowwhite.png"></a>
    </div>
  </div>
</div>
  ...
  <div class="container ">
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-2">
        <a href="{{ route('horoscope.daily', $zSign->slug) }}" class="sec5Box">
          <span class="sec5icon"><img src="{{ str_contains($zSign->icon, 'frontend/') ? asset($zSign->icon) : asset($zSign->icon) }}" /></span>
