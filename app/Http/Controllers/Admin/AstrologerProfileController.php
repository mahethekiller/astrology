...
class AstrologerProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'chat_commission_percentage' => 'nullable|numeric|min:0|max:100',
            'call_commission_percentage' => 'nullable|numeric|min:0|max:100',
        ...
        try {
            ...
            $profile = AstrologerProfile::create([
                ...
                'chat_commission_percentage' => $request->chat_commission_percentage,
                'call_commission_percentage' => $request->call_commission_percentage,
                'about' => $request->about,
